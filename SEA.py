...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Date       2021/1/1 
    Insta     https://instagram.com/qais0alkurdi
...
#	آسف ، لقد قمت بتشفير ميزة unfriend لأنها لا تفعل ذلك
#	يسمح به صاحب fb bot :)
#	بالنسبة لأولئك الذين يمكن أن يكونوا غير منظمين ، يرجى استخدامه بنفسك
